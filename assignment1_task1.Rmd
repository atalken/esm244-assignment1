...
```{r, warning=FALSE, message=FALSE, fig.cap= "Figure 1. Top: The change in Mountain Yellow-Legged Frog populations from 1995 to 2002 for different life stages - adults, subadults and tadpoles. Bottom: The top 5 lakes with the highest number of adult and subadult Mountain Yellow-Legged Frogs."}
